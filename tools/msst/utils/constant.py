...
# webui config path
WEBUI_CONFIG = "tools/msst/data/webui_config.json"
...
# language data path
LANGUAGE = "tools/msst/data/language.json"


# path to models information config
MODELS_INFO = "tools/msst/data/models_info.json"

# path to pretrain folder
MODEL_FOLDER = "tools/msst/pretrain"

# path to temp folder
TEMP_PATH = "tools/msst/tmpdir"
...
THEME_FOLDER = "tools/msst/themes"
